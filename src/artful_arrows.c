...
#include "common.h" 	// Beej assert macro
	...
	// Save/Load StorageValue don't work on web, these are equivalents using browser's local storage feature https://developer.mozilla.org/en-US/docs/Web/API/Storage
...
int main(void)
{
	...
	// SetMusicVolume(music, 2.0f); (optional)
